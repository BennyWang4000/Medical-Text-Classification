...
```
## **Discussion**
從前也有在其他地方寫過教學文，這次想要有所突破，仿造其他人package的作法。雖說想要往NLP的方向前進，但說來慚愧，這是筆者第一支完成的NLP project，目前還在執行的其他專案還面臨著大方向的問題，還在尋找適合的解決方法，查了許多資料也都沒有起色。期望往後能在這支專案中找到什麼靈感。
